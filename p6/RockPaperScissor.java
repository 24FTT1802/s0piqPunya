    ...
    public static void main(String[] args) {
        ...
        if (ans == 0){
            switch (choice) {
                ...
                case 1: System.out.println("The computer is rock. You are Scissor. You Lose."); break;
            ...
            switch (choice){
                ...
                case 1: System.out.println("The computer is scissor. You are scissor. It is a draw."); break;
            ...
            switch (choice){
                ...
                case 1: System.out.println("The computer is paper. You are scissor. You Win."); break;
